//frontend\src\components\ui\SelectCompHistorial.tsx
"use client";
...
interface SelectCompHistorialProps {
  ...
  showPabellon?: boolean; // Nueva propiedad opcional
}

const SelectCompHistorial: FC<SelectCompHistorialProps> = ({
  ...
  onModuloUrChange,
  onPabellonChange,
  showPabellon = true, // Valor por defecto
}) => {
...
export default SelectCompHistorial;