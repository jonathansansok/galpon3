...
interface PrevencionesSelectProps {
  initialSectors: Sector[];
  onSelect: (selectedSectors: Sector[]) => void;
}

const PrevencionesSelect: FC<PrevencionesSelectProps> = ({ initialSectors, onSelect }) => {
...
export default PrevencionesSelect;