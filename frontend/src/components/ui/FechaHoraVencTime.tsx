...
const FechaHoraVencTime = ({ value, onChange }: { value: string; onChange: (value: string) => void }) => {
  ...
  return (
    <div className="relative">
      <label
        htmlFor="fechaHoraVencTime"
        className="block text-sm font-medium text-gray-700 dark:text-gray-300"
      >
        Fecha de Vencimiento Condena:
      </label>
      <DatePicker
        id="fechaHoraVencTime"
        selected={date}
...
export default FechaHoraVencTime;