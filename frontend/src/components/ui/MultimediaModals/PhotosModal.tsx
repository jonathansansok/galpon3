...
interface PhotosModalProps {
  ...
  imagenesHistorial: { [key: string]: string[] }; // Historial de imágenes
}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-md flex justify-center items-center z-50 mt-0 !m-0">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full h-full max-w-screen-lg max-h-screen-lg relative grid grid-cols-1 sm:grid-cols-2 gap-4 overflow-y-auto">
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse title="Ver fotografía rostro" isOpenByDefault={!!imagen}>
            {imagen && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagen"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagen"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`rostro_historial_${index}`)}
                  >
                    <button
                      type="button"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotografía perfil derecho"
            isOpenByDefault={!!imagenDer}
          >
            {imagenDer && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenDer"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenDer"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`derecha_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotografía perfil izquierdo"
            isOpenByDefault={!!imagenIz}
          >
            {imagenIz && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenIz"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenIz"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`izquierda_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotografía dactilar"
            isOpenByDefault={!!imagenDact}
          >
            {imagenDact && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenDact"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenDact"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`dactilar_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotos de señas part.-tatuajes 1"
            isOpenByDefault={!!imagenSen1}
          >
            {imagenSen1 && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenSen1"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenSen1"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`señas1_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotos de señas part.-tatuajes 2"
            isOpenByDefault={!!imagenSen2}
          >
            {imagenSen2 && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenSen2"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenSen2"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`señas2_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotos de señas part.-tatuajes 3"
            isOpenByDefault={!!imagenSen3}
          >
            {imagenSen3 && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenSen3"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenSen3"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`señas3_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotos de señas part.-tatuajes 4"
            isOpenByDefault={!!imagenSen4}
          >
            {imagenSen4 && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenSen4"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenSen4"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`señas4_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotos de señas part.-tatuajes 5"
            isOpenByDefault={!!imagenSen5}
          >
            {imagenSen5 && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenSen5"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenSen5"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`señas5_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="mt-4 flex-1 min-w-full sm:min-w-0 sm:w-full">
          ...
          <Collapse
            title="Ver Fotos de señas part.-tatuajes 6"
            isOpenByDefault={!!imagenSen6}
          >
            {imagenSen6 && (
              <div className="mt-4">
          ...
          {/* Botón para descargar imágenes antiguas */}
          {imagenesHistorial && imagenesHistorial["imagenSen6"] && (
            <Collapse title="Descargar imágenes antiguas">
              {imagenesHistorial["imagenSen6"].map((img, index) => (
                <div key={index} className="mt-2">
                  <a
                    href={getImageUrl(img)}
                    download={generateFileName(`señas6_historial_${index}`)}
                  >
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
