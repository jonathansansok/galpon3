...
const FechaHoraReintegro = ({ value, onChange }: { value: string; onChange: (value: string) => void }) => {
  ...
  return (
    <div className="relative">
      <label
        htmlFor="fechaHoraReintegro"
        className="block text-sm font-medium text-gray-700 dark:text-gray-300"
      >
        Fecha y hora de Reintegro:
      </label>
      <DatePicker
        id="fechaHoraReintegro"
        selected={date}
...
export default FechaHoraReintegro;