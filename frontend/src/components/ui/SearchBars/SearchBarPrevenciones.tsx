...
import { Prevencion } from "@/types/Prevencion"; // Importa la interfaz Prevencion
import { PrevencionSearchResult } from "@/types/SearchResult"; // Importa la interfaz PrevencionSearchResult
...
interface SearchBarProps {
  data: Prevencion[];
  onSearchResults: (results: PrevencionSearchResult[]) => void;
}
...
export function SearchBarPrevenciones({ data, onSearchResults }: SearchBarProps) {
  ...
  const handleSearchClick = async () => {
    ...
    let results: PrevencionSearchResult[];
