// frontend/src/components/ui/SearchBars/SearchBarAtentados.tsx
"use client";

import { useState } from "react";
import Fuse from "fuse.js";
import { Atentado, SearchResult } from "@/types/Atentado"; // Importa la interfaz Atentado y SearchResult
...
export function SearchBarAtentados({ data = [], onSearchResults }: SearchBarProps) {
  ...
  console.log("Data recibida en SearchBarAtentados:", data);
