...
export function SearchBarExtramuros({ data, onSearchResults }: SearchBarProps) {
  ...
  const normalizedData = Array.isArray(data)
    ? data.map((item) => {
        ...
        if (item.fechaHoraReintegro) {
          normalizedItem.fechaHoraReintegroFormatted = formatDate(new Date(item.fechaHoraReintegro));
        }
