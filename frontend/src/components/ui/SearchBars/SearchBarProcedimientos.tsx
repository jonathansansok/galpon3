...
import { Procedimiento } from "@/types/Procedimiento"; // Importa la interfaz Procedimiento
import { ProcedimientoSearchResult } from "@/types/SearchResult"; // Importa la interfaz ProcedimientoSearchResult
...
interface SearchBarProps {
  data: Procedimiento[];
  onSearchResults: (results: ProcedimientoSearchResult[]) => void;
}
...
export function SearchBarProcedimientos({ data, onSearchResults }: SearchBarProps) {
  ...
  const handleSearchClick = async () => {
    ...
    let results: ProcedimientoSearchResult[];
