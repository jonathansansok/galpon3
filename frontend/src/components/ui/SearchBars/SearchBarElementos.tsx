...
export function SearchBarElementos({ data, onSearchResults }: SearchBarProps) {
  ...
  const fuse = new Fuse(normalizedData, {
    keys: [
      ...
      "internosinvolucrado",
      "email",
      "internosinvolucrado.nombreApellido",
      "internosinvolucrado.alias",
      "internosinvolucrado.lpu",
      "internosinvolucrado.lpuProv",
      "internosinvolucrado.sitProc",
      "internosinvolucrado.gravedad",
      "internosinvolucrado.atencionExtramuro",
      "internosinvolucrado.detalle",
      "armas.tipoArma",
      "armas.tipoEspecifico",
      "armas.medida",
      "armas.detalles",
      "armas.dentroCelda",
      "armas.sectorHabitacional",
      "armas.donde",
      "armas.pabellon",
      "armas.otroSector",
      "armas.otroDetalle",
      "componentes.tipoComponente",
      "componentes.tipoEspecifico",
      "componentes.marca",
      "componentes.modelo",
      "componentes.medida",
      "componentes.detalles",
      "componentes.dentroCelda",
      "componentes.sectorHabitacional",
      "componentes.donde",
      "componentes.pabellon",
      "componentes.otroSector",
      "componentes.otroDetalle",
      "electronicos.tipoElectronico",
      "electronicos.marca",
      "electronicos.modelo",
      "electronicos.imei",
      "electronicos.medida",
      "electronicos.detalles",
      "electronicos.dentroCelda",
      "electronicos.sectorHabitacional",
      "electronicos.donde",
      "electronicos.pabellon",
      "electronicos.otroSector",
      "electronicos.otroDetalle",
      "estupefacientes.sectorHabitacional",
      "estupefacientes.otroSector",
      "estupefacientes.donde",
      "estupefacientes.otroDetalle",
      "estupefacientes.tipoTenencia",
      "estupefacientes.tipoEstupefaciente",
      "estupefacientes.pesoEstupefaciente",
      "estupefacientes.unidadPeso",
      "estupefacientes.detalle",
      "estupefacientes.dentroCelda",
      "estupefacientes.pabellon",
    ],
    threshold: 0.3,
    ignoreLocation: true,
