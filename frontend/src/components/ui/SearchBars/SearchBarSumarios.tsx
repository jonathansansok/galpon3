// frontend/src/components/ui/SearchBars/SearchBarSumarios.tsx
...
export function SearchBarSumarios({ data, onSearchResults }: SearchBarProps) {
  ...
  const handleSearchClick = async () => {
    ...
    results = results.filter((result) => {
      const itemDate = new Date(result.item.fechaHora);
