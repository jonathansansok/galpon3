...
interface SearchBarProps {
  data: Riesgo[] | undefined; // Asegúrate de que data pueda ser undefined
...
export function SearchBarRiesgos({ data, onSearchResults }: SearchBarProps) {
  ...
  const handleSearchClick = async () => {
    ...
    if (query === "" && additionalQuery === "") {
      ...
      results = fuse
        ...
        .map((result) => ({
          item: data![result.refIndex], // Usa el operador `!` porque ya validamos que data es un array
