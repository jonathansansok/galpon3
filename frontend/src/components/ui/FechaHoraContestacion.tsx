...
const FechaHoraContestacion = ({ value, onChange }: { value: string; onChange: (value: string) => void }) => {
  ...
  return (
    <div className="relative">
      <label
        htmlFor="fechaHoraContestacion"
        className="block text-sm font-medium text-gray-700 dark:text-gray-300"
      >
        Fecha y hora de Contestación:
      </label>
      <DatePicker
        id="fechaHoraContestacion"
        selected={date}
...
export default FechaHoraContestacion;