              ...
              <td className="py-4 px-6 text-sm text-gray-700 flex space-x-2">
                <button
                  onClick={(e) => {
                    ...
                    handleUpdateRow(row); // Llamar a la función de actualización
                  }}
          ...
          <tr className="bg-gray-50">
              ...
              <select
                ...
                onChange={(e) =>
                  setNewRow({
                    ...
                    horas: piezasConValores[e.target.value as PiezaKey]?.horas || 0,
                    costo: piezasConValores[e.target.value as PiezaKey]?.costo || 0,
                  })
                }
                className="border border-gray-300 rounded-lg px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <td className="py-4 px-2 w-[80px]">
              <input
                ...
                value={newRow.horas}
                onChange={(e) =>
                  setNewRow({ ...newRow, horas: parseFloat(e.target.value) || 0 })
                }
                className="border border-gray-300 rounded-lg px-2 py-1 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </td>
            <td className="py-4 px-2 w-[80px]">
              <input
                ...
                value={newRow.costo}
                onChange={(e) =>
                  setNewRow({ ...newRow, costo: parseFloat(e.target.value) || 0 })
                }
                className="border border-gray-300 rounded-lg px-2 py-1 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </td>
