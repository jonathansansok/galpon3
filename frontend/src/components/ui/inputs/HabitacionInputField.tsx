...
interface HabitacionInputFieldProps {
...
export function HabitacionInputField({
  register,
  placeholder,
  label,
}: HabitacionInputFieldProps) {
  return (
    <div className="relative mb-4">
      {/* Input field con la etiqueta flotante */}
      <input
        {...register("habitacion")} // Usamos register de react-hook-form para enlazar el input
        id="habitacion" // El id es igual al nombre del campo
        name="habitacion" // El nombre también será igual al nombre del campo
      ...
      />
      <label
        htmlFor="habitacion" // Relacionamos la etiqueta con el input a través del "name"
