// Definimos las propiedades del componente InputFieldPorOrdenDe
interface InputFieldPorOrdenDeProps {
  ...
  export function InputFieldPorOrdenDe({
    name,
    placeholder,
    label,
    value,
    onChange,
  }: InputFieldPorOrdenDeProps) {
    return (
      <div className="relative mb-4">
        ...
        <input
          ...
          onChange={(e) => onChange(e.target.value)} // Manejar el cambio de valor
        />
        <label
