...
export function PisoInputField({
  register,
  placeholder,
  label,
}: PisoInputFieldProps) {
  return (
    <div className="relative mb-4">
      ...
      <input
        {...register("piso")} // Usamos register de react-hook-form para enlazar el input
        id="piso" // El id es igual al nombre del campo
        name="piso" // El nombre también será igual al nombre del campo
      ...
      />
      <label
        htmlFor="piso" // Relacionamos la etiqueta con el input a través del "name"
