...
export function CamaInputField({
  register,
  placeholder,
  label,
}: CamaInputFieldProps) {
  return (
    <div className="relative mb-4">
      ...
      <input
        {...register("cama")} // Usamos register de react-hook-form para enlazar el input
        id="cama" // El id es igual al nombre del campo
        name="cama" // El nombre también será igual al nombre del campo
      ...
      />
      <label
        htmlFor="cama" // Relacionamos la etiqueta con el input a través del "name"
