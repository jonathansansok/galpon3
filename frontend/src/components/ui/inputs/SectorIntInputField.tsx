...
// Definimos las propiedades del componente SectorIntInputField
interface SectorIntInputFieldProps {
...
export function SectorIntInputField({
  register,
  placeholder,
  label,
}: SectorIntInputFieldProps) {
  return (
    <div className="relative mb-4">
      {/* Input field con la etiqueta flotante */}
      <input
        {...register("sector_internacion")} // Usamos register de react-hook-form para enlazar el input
        id="sector_internacion" // El id es igual al nombre del campo
        name="sector_internacion" // El nombre también será igual al nombre del campo
      ...
      />
      <label
        htmlFor="sector_internacion" // Relacionamos la etiqueta con el input a través del "name"
