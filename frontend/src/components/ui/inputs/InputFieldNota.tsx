...
export function InputFieldNota({
  register,
  placeholder,
  label,
}: InputFieldNotaProps) {
  return (
    <div className="relative mb-4">
      ...
      <input
        {...register("nota")} // Usamos register de react-hook-form para enlazar el input
        id="nota" // El id es igual al nombre del campo
        name="nota" // El nombre también será igual al nombre del campo
      ...
      />
      <label
        htmlFor="nota" // Relacionamos la etiqueta con el input a través del "name"
