...
interface InputFieldHospitalProps {
...
export function HospitalInputField({
  register,
  placeholder,
  label,
}: InputFieldHospitalProps) {
  return (
    <div className="relative mb-4">
      {/* Input field con la etiqueta flotante */}
      <input
        {...register("hospital")} // Usamos register de react-hook-form para enlazar el input
        id="hospital" // El id es igual al nombre del campo
        name="hospital" // El nombre también será igual al nombre del campo
      ...
      />
      <label
        htmlFor="hospital" // Relacionamos la etiqueta con el input a través del "name"
