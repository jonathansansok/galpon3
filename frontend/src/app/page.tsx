...
export default function HomePage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen flex-col w-full mt-0">
      {user ? (
        <>
          <div className="bg-white shadow-2xl mb-6 w-full max-w-6xl flex flex-col md:flex-row rounded-2xl overflow-hidden">
            ...
            <div className="md:w-2/3 p-6">
              ...
              <p className="text-lg mb-6 text-gray-700 leading-relaxed">
                Texto a elección. Este es un ejemplo de cómo puedes estructurar
                el contenido para que sea claro y atractivo visualmente.
              </p>
              <button
          ...
          <div className="bg-gray-200 shadow-lg p-6 w-full max-w-6xl rounded-lg">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Texto a elección. Este sistema es una herramienta clave para la
              gestión de información y la toma de decisiones estratégicas.
            </p>
          </div>
