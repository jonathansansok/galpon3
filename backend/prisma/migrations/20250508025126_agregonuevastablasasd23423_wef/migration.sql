/*
  ...
  - You are about to drop the column `clienteId` on the `temas` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `temas` DROP FOREIGN KEY `Temas_clienteId_fkey`;

-- DropIndex
DROP INDEX `Temas_clienteId_fkey` ON `temas`;
...
-- AlterTable
ALTER TABLE `temas` DROP COLUMN `clienteId`;
