...
CREATE TABLE `Moviles` (
    ...
    `tipoPintura` VARCHAR(100) NOT NULL,
    `paisOrigen` VARCHAR(100) NOT NULL,
    `tipoVehic` VARCHAR(100) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Moviles` ADD CONSTRAINT `Moviles_ingresoId_fkey` FOREIGN KEY (`ingresoId`) REFERENCES `Ingresos`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
