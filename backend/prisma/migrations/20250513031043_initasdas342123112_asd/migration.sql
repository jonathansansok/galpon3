/*
  ...
  - You are about to alter the column `monto` on the `presupuestos` table. The data in that column could be lost. The data in that column will be cast from `Double` to `VarChar(191)`.
...
-- AlterTable
ALTER TABLE `presupuestos` MODIFY `movilId` VARCHAR(191) NULL,
    MODIFY `monto` VARCHAR(191) NULL;
