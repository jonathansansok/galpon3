/*
  ...
  - You are about to drop the column `movilId` on the `presupuestos` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `presupuestos` DROP COLUMN `movilId`;
