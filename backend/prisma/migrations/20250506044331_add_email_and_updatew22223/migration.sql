...
-- AlterTable
ALTER TABLE `ingresos` ADD COLUMN `dias` VARCHAR(10) NULL,
    ADD COLUMN `iva` VARCHAR(50) NULL,
    ADD COLUMN `numeroCuit` VARCHAR(20) NULL,
    ADD COLUMN `porcB` VARCHAR(10) NULL,
    ADD COLUMN `porcRetIB` VARCHAR(10) NULL,
    ADD COLUMN `pyme` BOOLEAN NULL DEFAULT false,
