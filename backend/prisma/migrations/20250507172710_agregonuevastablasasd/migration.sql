...
-- AlterTable
ALTER TABLE `temas` ADD COLUMN `clienteId` INTEGER NULL;
...
-- AddForeignKey
ALTER TABLE `Temas` ADD CONSTRAINT `Temas_clienteId_fkey` FOREIGN KEY (`clienteId`) REFERENCES `Ingresos`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
