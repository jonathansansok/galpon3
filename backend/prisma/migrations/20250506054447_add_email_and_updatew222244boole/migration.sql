/*
  ...
  - You are about to alter the column `pyme` on the `ingresos` table. The data in that column could be lost. The data in that column will be cast from `TinyInt` to `VarChar(5)`.
