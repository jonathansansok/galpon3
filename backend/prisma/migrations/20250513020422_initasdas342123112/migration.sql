/*
  ...
  - You are about to drop the column `clienteId` on the `presupuestos` table. All the data in the column will be lost.
  - You are about to drop the column `datosCliente` on the `presupuestos` table. All the data in the column will be lost.
  - You are about to drop the column `datosMovil` on the `presupuestos` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `presupuestos` DROP COLUMN `clienteId`,
    DROP COLUMN `datosCliente`,
    DROP COLUMN `datosMovil`;
