/*
  ...
  - You are about to drop the column `marca` on the `autos` table. All the data in the column will be lost.
  ...
  - Added the required column `label` to the `Autos` table without a default value. This is not possible if the table is not empty.
  - Added the required column `value` to the `Autos` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `autos` DROP COLUMN `marca`,
    ADD COLUMN `label` VARCHAR(500) NOT NULL,
    ADD COLUMN `value` VARCHAR(500) NOT NULL;
